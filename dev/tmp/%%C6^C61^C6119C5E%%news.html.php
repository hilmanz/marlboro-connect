<?php /* Smarty version 2.6.13, created on 2011-12-02 10:58:20
...
" style="right: -9px;top: -25px;">&nbsp;</a>
                                <div>
                                    <p style="font-size:20px"><?php echo ((is_array($_tmp=$this->_tpl_vars['list'][$this->_sections['i']['index']]['news_content'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</p>
                                </div>
                  </div>
                  <?php endfor; endif; ?>
