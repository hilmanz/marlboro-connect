<?php /* Smarty version 2.6.13, created on 2011-12-05 04:33:35
         compiled from marlboro/terms-and-condition.html */ ?>
    ...
    <div id="content">
    	<div id="term">
        	<div class="content">
            	<div class="term" style="width: 550px;">  
                <div class="light"></div>
                 	<h1>TERMS & CONDITIONS</h1>
                 	<div id="scrollcApp" style="height:550px; margin-bottom: 175px; height: 370px;width: 550px;">
                 	<div class="scrollcApp" style="height:2900px;width: 550px;">
  ...
  <ol style="text-align:left">
 	...
 	<div style="position:relative;">            	  	
        <input id="up" type="button" style="bottom: 170px;right: -30px;">
		<input id="down" type="button" style="bottom: 170px;right: -64px;">  
		</div>             	  	
                </div>
            </div><!-- .content -->
        </div><!-- #news -->
    </div><!-- #content -->
<div class="page-terms"></div>