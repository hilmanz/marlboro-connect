...
<div id="body">
    <div id="top">
        <div id="logoCilent">
            <img id="marl-logo" src="images/marlboro/logo.png" />
        ...
        <div id="topmenu">
            <ul>
                ...
                <li><span><a href="index.php?s=reporting">Dashboard</a></span></li>
            </ul>
        </div>
    </div>
    <!-- css menu tree -->
    <div class="nav">
        <ul class="menu" id="menu">
            <!--<li><a href="index.php?s=performance">Dashboard</a></li>-->
			<li>
				<a href="#">Badge</a>
				<ul>
					<li><a href="index.php?s=code&act=redeem-code">Redeem Code</a></li>
					<li><a href="#">Redeem Code Generator</a></li>
					<li><a href="index.php?s=code&act=redeem-history">Badge Redeemed History</a></li>
					<li><a href="index.php?s=code&act=edit-badge">Edit Badge</a></li>
                    <li><a href="index.php?s=code&act=redeem-request">Redeem Badge Request</a></li>
                    <li><a href="index.php?s=code&act=allocation">Badge Allocation</a></li>
                    <li><a href="index.php?s=code&act=info">Code Info</a></li>
					<li><a href="index.php?s=code&act=universal">Universal</a></li>
				</ul>
			</li>
			<li>
				<a href="index.php?s=user">User</a>
				<ul>
					<li><a href="index.php?s=user">User Database</a></li>
					<li><a href="index.php?s=user&act=trace">Trace User</a></li>
				</ul>
			</li>
			<li>
				<a href="#">News</a>
				<ul>
					<li><a href="index.php?s=news">Browse</a></li>
					<li><a href="index.php?s=news&act=new">Add New</a></li>
				</ul>
			</li>
			<li>
				<a href="index.php?s=message">Message</a>
			</li>
			<li>
				<a href="index.php?s=mobile">Mobile Registrations</a>
			</li>
            <li>
				<a href="#">Reporting</a>
				<ul>
					<li><a href="index.php?s=reporting">Dashboard</a></li>
					<li><a href="index.php?s=reporting&act=website-activity">Website Activity</a></li>
                    <li><a href="index.php?s=reporting&act=badges-redemption">Code Redemption</a></li>
					<li><a href="index.php?s=reporting&act=user">User</a></li>
					<li><a href="index.php?s=reporting&act=badges-trading">Badges & Trading</a></li>
				</ul>
			</li>
        </ul>
        <br style="clear: left" />
